...
var app = (function () {
    ...
    class Home extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*news*/ ctx[0] === undefined && !('news' in props)) {
    			console.warn("<Home> was created without expected prop 'news'");
    		}
    	}
    ...
    const file$2 = "src/routes/News.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			add_location(main, file$2, 5, 0, 60);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<News> was created with unknown prop '${key}'`);
    	});
    ...
    class News extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*id*/ ctx[0] === undefined && !('id' in props)) {
    			console_1.warn("<News> was created without expected prop 'id'");
    		}
    	}
    ...
    // (21:12) <Link to="/" class="btn mb-4 btn-lg btn-primary">
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(21:12) <Link to=\\\"/\\\" class=\\\"btn mb-4 btn-lg btn-primary\\\">",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			h1 = element("h1");
    			h1.textContent = `${/*newsinfo*/ ctx[0][0].title}`;
    			t1 = space();
    			div2 = element("div");
    			center = element("center");
    			create_component(link.$$.fragment);
    			...
    			add_location(h1, file$1, 15, 8, 298);
    			attr_dev(div0, "class", "px-4 my-5 text-center");
    			add_location(div0, file$1, 14, 4, 254);
    			add_location(center, file$1, 19, 8, 385);
    			attr_dev(iframe, "class", "responsive-iframe svelte-1085eph");
    			attr_dev(iframe, "title", "News");
    			if (!src_url_equal(iframe.src, iframe_src_value = /*newsinfo*/ ctx[0][0].link)) attr_dev(iframe, "src", iframe_src_value);
    			iframe.allowFullscreen = true;
    			add_location(iframe, file$1, 25, 12, 597);
    			attr_dev(div1, "class", "embed-responsive embed-responsive-16by9");
    			add_location(div1, file$1, 24, 8, 531);
    			attr_dev(div2, "class", "m-4");
    			add_location(div2, file$1, 18, 4, 359);
    			add_location(main, file$1, 13, 0, 243);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Link, urlParams, id, news, newsinfo });

    	$$self.$inject_state = $$props => {
    		if ('id' in $$props) id = $$props.id;
    		if ('news' in $$props) $$invalidate(1, news = $$props.news);
    		if ('newsinfo' in $$props) $$invalidate(0, newsinfo = $$props.newsinfo);
    	};
    	...
    	return [newsinfo, news];
    }

    class NewsView extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { news: 1 });
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const home_changes = {};
    			if (dirty & /*news*/ 1) home_changes.news = /*news*/ ctx[0];
    ...
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(17:2) <Route path=\\\"newsview\\\">",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	route2 = new Route({
    			props: { path: "news/:id", component: News },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 12, 1, 267);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { news: 0, url: 1 });
